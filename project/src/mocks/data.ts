import type { Role, User, Bank, Client, PaymentType, Article, Statement, Payment, ErrorItem, LogEntry, DashboardData, ReportData, OneCOrganization, OneCContract, OneCExportDocument, OneCExchangeLogEntry } from '@/types';
...
export const mockPayments: Payment[] = [
  { id: 1, statement_id: 1, doc_number: '1248', doc_date: today, amount: 202898.75, payer_name: 'ООО "Мави Джинс"', payer_inn: '7734660892', payer_account: '', payee_name: 'ООО "Социальные услуги"', payee_inn: '7713699602', payee_account: '', purpose: 'Оплата по счету № 1595/92 от 01.04.2026 обслуживание за 05.2026', payment_type_id: 1, article_id: 1, client_id: 1, contract_id: null, contract_number: '', status: 'processed', client_name: 'ООО "Мави Джинс"', payment_type_name: 'Поступление', article_name: 'Поступления от оказания социальных услуг' },
  { id: 2, statement_id: 1, doc_number: '1356', doc_date: today, amount: 157000, payer_name: 'Департамент труда и соцзащиты г. Москвы', payer_inn: '7710660053', payer_account: '', payee_name: 'ООО "Социальные услуги"', payee_inn: '7713699602', payee_account: '', purpose: 'Оплата по госконтракту № 2026-045 от 15.01.2026', payment_type_id: 1, article_id: 1, client_id: 4, contract_id: null, contract_number: '', status: 'processed', client_name: 'Департамент труда и соцзащиты г. Москвы', payment_type_name: 'Поступление', article_name: 'Поступления от оказания социальных услуг' },
  { id: 3, statement_id: 1, doc_number: '1275', doc_date: today, amount: 89000, payer_name: 'ИП Иванов И.И.', payer_inn: '771501001234', payer_account: '', payee_name: 'ООО "Социальные услуги"', payee_inn: '7713699602', payee_account: '', purpose: 'Оплата по договору № 12 от 10.01.2026', payment_type_id: 1, article_id: 1, client_id: 3, contract_id: null, contract_number: '', status: 'processed', client_name: 'ИП Иванов И.И.', payment_type_name: 'Поступление', article_name: 'Поступления от оказания социальных услуг' },
  { id: 4, statement_id: 1, doc_number: '1401', doc_date: today, amount: 45000, payer_name: 'ООО "Социальные услуги"', payer_inn: '7713699602', payer_account: '', payee_name: 'ООО "Ромашка"', payee_inn: '7728300200', payee_account: '', purpose: 'Оплата по договору № 45 от 12.02.2026 за канцелярские товары', payment_type_id: 2, article_id: 2, client_id: 5, contract_id: null, contract_number: '', status: 'processed', client_name: 'ООО "Ромашка"', payment_type_name: 'Списание', article_name: 'Оплата товаров и материалов' },
  { id: 5, statement_id: 1, doc_number: '1402', doc_date: today, amount: 32000.5, payer_name: 'ООО "Социальные услуги"', payer_inn: '7713699602', payer_account: '', payee_name: 'АО "Флант"', payee_inn: '7702033720', payee_account: '', purpose: 'Оплата по счету № FL-887 за услуги хостинга', payment_type_id: 2, article_id: 6, client_id: 2, contract_id: null, contract_number: '', status: 'processed', client_name: 'АО "Флант"', payment_type_name: 'Списание', article_name: 'Услуги связи и интернета' },
  { id: 6, statement_id: 1, doc_number: '1403', doc_date: today, amount: 18500, payer_name: 'Неизвестный отправитель', payer_inn: '0000000000', payer_account: '', payee_name: 'ООО "Социальные услуги"', payee_inn: '7713699602', payee_account: '', purpose: 'Оплата по договору № Н/Д', payment_type_id: 1, article_id: null, client_id: null, contract_id: null, contract_number: '', status: 'manual' },
  { id: 7, statement_id: 1, doc_number: '1404', doc_date: today, amount: 77000, payer_name: 'ООО "Социальные услуги"', payer_inn: '7713699602', payer_account: '', payee_name: 'ООО "ТехноПром"', payee_inn: '0000000001', payee_account: '', purpose: 'Предоплата по договору поставки № 88/П', payment_type_id: 2, article_id: null, client_id: null, contract_id: null, contract_number: '', status: 'error' },
  { id: 8, statement_id: 1, doc_number: '1405', doc_date: today, amount: 12500, payer_name: 'ООО "Социальные услуги"', payer_inn: '7713699602', payer_account: '', payee_name: 'ИП Сидоров А.В.', payee_inn: '0000000002', payee_account: '', purpose: 'Оплата транспортных услуг по сч. № ТР-156', payment_type_id: 2, article_id: null, client_id: null, contract_id: null, contract_number: '', status: 'manual' },
  { id: 9, statement_id: 2, doc_number: '1180', doc_date: '2026-04-15', amount: 195000, payer_name: 'Департамент труда и соцзащиты г. Москвы', payer_inn: '7710660053', payer_account: '', payee_name: 'ООО "Социальные услуги"', payee_inn: '7713699602', payee_account: '', purpose: 'Оплата по госконтракту № 2026-045 за март 2026', payment_type_id: 1, article_id: 1, client_id: 4, contract_id: null, contract_number: '', status: 'processed', client_name: 'Департамент труда и соцзащиты г. Москвы' },
  { id: 10, statement_id: 2, doc_number: '1191', doc_date: '2026-04-14', amount: 43200, payer_name: 'ООО "Социальные услуги"', payer_inn: '7713699602', payer_account: '', payee_name: 'ООО "Медтехника-Сервис"', payee_inn: '7718014456', payee_account: '', purpose: 'Оплата по сч. № МТ-445 за медицинское оборудование', payment_type_id: 2, article_id: 2, client_id: 7, contract_id: null, contract_number: '', status: 'processed' },
  { id: 11, statement_id: 2, doc_number: '1195', doc_date: '2026-04-12', amount: 56000, payer_name: 'ИП Петрова М.С.', payer_inn: '772000112345', payer_account: '', payee_name: 'ООО "Социальные услуги"', payee_inn: '7713699602', payee_account: '', purpose: 'Оплата по договору № 34 за catering-услуги', payment_type_id: 1, article_id: 7, client_id: 15, contract_id: null, contract_number: '', status: 'processed' },
  { id: 12, statement_id: 2, doc_number: '1203', doc_date: '2026-04-10', amount: 128000, payer_name: 'ООО "Социальные услуги"', payer_inn: '7713699602', payer_account: '', payee_name: 'АО "ВСК"', payee_inn: '7710026574', payee_account: '', purpose: 'Страховая премия по дог. № 567-С/2026', payment_type_id: 2, article_id: 4, client_id: 17, contract_id: null, contract_number: '', status: 'processed' },
  { id: 13, statement_id: 2, doc_number: '1210', doc_date: '2026-04-08', amount: 34000, payer_name: 'ООО "Социальные услуги"', payer_inn: '7713699602', payer_account: '', payee_name: 'ООО "ТехСнаб"', payee_inn: '0000000003', payee_account: '', purpose: 'Оплата по сч. ТС-789 за хозтовары', payment_type_id: 2, article_id: null, client_id: null, contract_id: null, contract_number: '', status: 'manual' },
  { id: 14, statement_id: 2, doc_number: '1215', doc_date: '2026-04-05', amount: 91500, payer_name: 'АНО "ЦСП "Надежда"', payer_inn: '0000000004', payer_account: '', payee_name: 'ООО "Социальные услуги"', payee_inn: '7713699602', payee_account: '', purpose: 'Благотворительный взнос по договору', payment_type_id: 1, article_id: null, client_id: null, contract_id: null, contract_number: '', status: 'manual' },
  { id: 15, statement_id: 3, doc_number: '1501', doc_date: today, amount: 250000, payer_name: 'Департамент труда и соцзащиты г. Москвы', payer_inn: '7710660053', payer_account: '', payee_name: 'ООО "Социальные услуги"', payee_inn: '7713699602', payee_account: '', purpose: 'Оплата по госконтракту № 2026-045 за май 2026', payment_type_id: 1, article_id: null, client_id: 4, contract_id: null, contract_number: '', status: 'processed' },
  { id: 16, statement_id: 3, doc_number: '1502', doc_date: today, amount: 67000, payer_name: 'ООО "Социальные услуги"', payer_inn: '7713699602', payer_account: '', payee_name: 'ПАО "МГТС"', payee_inn: '7710016640', payee_account: '', purpose: 'Оплата услуг связи за июнь 2026', payment_type_id: 2, article_id: null, client_id: 11, contract_id: null, contract_number: '', status: 'processed' },
  { id: 17, statement_id: 3, doc_number: '1503', doc_date: today, amount: 54000, payer_name: 'ООО "Социальные услуги"', payer_inn: '7713699602', payer_account: '', payee_name: 'АО "Мосэнергосбыт"', payee_inn: '7736520080', payee_account: '', purpose: 'Оплата электроэнергии за май 2026', payment_type_id: 2, article_id: null, client_id: 13, contract_id: null, contract_number: '', status: 'processed' },
  { id: 18, statement_id: 3, doc_number: '1504', doc_date: today, amount: 38500, payer_name: 'ООО "Социальные услуги"', payer_inn: '7713699602', payer_account: '', payee_name: 'ООО "Клининг-Профи"', payee_inn: '7719078562', payee_account: '', purpose: 'Оплата клининговых услуг за июнь 2026', payment_type_id: 2, article_id: null, client_id: 12, contract_id: null, contract_number: '', status: 'processed' },
  { id: 19, statement_id: 3, doc_number: '1505', doc_date: today, amount: 93000, payer_name: 'ООО "Фарм-Поставка"', payer_inn: '7710645000', payer_account: '', payee_name: 'ООО "Социальные услуги"', payee_inn: '7713699602', payee_account: '', purpose: 'Возврат по акту сверки № ФП-223', payment_type_id: 1, article_id: null, client_id: 19, contract_id: null, contract_number: '', status: 'processed' },
];
...
// ==================== 1С: Интеграция (моковые данные) ====================

export const mockOneCOrganizations: OneCOrganization[] = [
...
export const mockOneCContracts: OneCContract[] = [
...
export const mockOneCExportDocuments: OneCExportDocument[] = [
  { paymentId: 1, docNumber: '1248', docDate: '2026-05-07', amount: 202898.75, clientName: 'ООО «Мави Джинс»', clientInn: '7734660892', operationType: 'Поступление', articleName: 'Поступления от оказания социальных услуг', purpose: 'Оплата по счету № 1595/92 от 01.04.2026 обслуживание за 05.2026', exportStatus: 'ready' },
  { paymentId: 2, docNumber: '1356', docDate: '2026-05-06', amount: 157000, clientName: 'Департамент труда и соцзащиты г. Москвы', clientInn: '7710660053', operationType: 'Поступление', articleName: 'Поступления от оказания социальных услуг', purpose: 'Оплата по госконтракту № 2026-045 от 15.01.2026', exportStatus: 'ready' },
  { paymentId: 3, docNumber: '1275', docDate: '2026-05-05', amount: 89000, clientName: 'ИП Иванов И.И.', clientInn: '771501001234', operationType: 'Поступление', articleName: 'Поступления от оказания социальных услуг', purpose: 'Оплата по договору № 12 от 10.01.2026', exportStatus: 'ready' },
  { paymentId: 4, docNumber: '1401', docDate: '2026-05-04', amount: 45000, clientName: 'ООО «Ромашка»', clientInn: '7728300200', operationType: 'Списание', articleName: 'Оплата товаров и материалов', purpose: 'Оплата по договору № 45 за канцелярские товары', exportStatus: 'ready' },
  { paymentId: 5, docNumber: '1402', docDate: '2026-05-03', amount: 32000.5, clientName: 'АО «Флант»', clientInn: '7702033720', operationType: 'Списание', articleName: 'Услуги связи и интернета', purpose: 'Оплата по счету № FL-887 за услуги хостинга', exportStatus: 'ready' },
  { paymentId: 9, docNumber: '1180', docDate: '2026-04-15', amount: 195000, clientName: 'Департамент труда и соцзащиты г. Москвы', clientInn: '7710660053', operationType: 'Поступление', articleName: 'Поступления от оказания социальных услуг', purpose: 'Оплата по госконтракту № 2026-045 за март 2026', exportStatus: 'sent', oneCDocNumber: 'ПТД-0000045', oneCDate: '2026-04-15' },
  { paymentId: 10, docNumber: '1191', docDate: '2026-04-14', amount: 43200, clientName: 'ООО «Медтехника-Сервис»', clientInn: '7718014456', operationType: 'Списание', articleName: 'Оплата товаров и материалов', purpose: 'Оплата по сч. № МТ-445 за медоборудование', exportStatus: 'posted', oneCDocNumber: 'СТД-0000078', oneCDate: '2026-04-14' },
];

const todayISO = new Date().toISOString().slice(0, 10);

export const mockOneCExchangeLog: OneCExchangeLogEntry[] = [
  { id: 1, operation: 'import_orgs', direction: 'import', description: 'Импорт организаций из 1С (2 записи)', count: 2, status: 'success', timestamp: todayISO + ' 09:00:00', userId: 1, userName: 'Чистякова М.В.' },
  { id: 2, operation: 'import_contracts', direction: 'import', description: 'Импорт договоров из 1С (8 записей)', count: 8, status: 'success', timestamp: todayISO + ' 09:05:00', userId: 1, userName: 'Чистякова М.В.' },
  { id: 3, operation: 'export_payments', direction: 'export', description: 'Экспорт 2 платежей в 1С (проведено: 1, ожидает: 1)', count: 2, status: 'partial', timestamp: todayISO + ' 15:30:00', userId: 2, userName: 'Петрова А.С.' },
  { id: 4, operation: 'export_payments', direction: 'export', description: 'Экспорт 5 платежей в 1С (проведено: 5)', count: 5, status: 'success', timestamp: todayISO + ' 16:00:00', userId: 2, userName: 'Петрова А.С.' },
];
